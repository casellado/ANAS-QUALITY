...
import { validaChainOfCustody, now } from '@verbali/shared'
...
export function VerbaleWizard({
    ...
    try {
      ...
      verbaleCompleto.storia = [
        ...(verbaleCompleto.storia ?? []),
        {
          ...
          note: `Wizard completato — ${tipoVerbale.nome}`,
        },
      ]
  ...
  }, [sigla, verbale, salvaBozza, setVerbale, onComplete, tipoVerbale.nome, toast])
